  ...
  return (
    <>
      ...
      <span className="reflink">
        ...
        <span className="reflinks" title="ID de post">
          {post.postId}
        </span>
      </span>
      <span className="extrabtns">
        {post.locked && (
          <img alt="Cerrado" src="https://www.hispachan.org/css/locked.gif" />
        )}
        {post.sticky && (
          <img
            alt="Hilo fijado"
            title="Hilo fijo"
            src="https://www.hispachan.org/css/sticky.gif"
          />
        )}
        {post.dice && (
          <img
            alt="Se permiten dados"
            title="En este hilo se permite lanzar dados"
            src="https://www.hispachan.org/buttons/dado.png"
          />
        )}
      </span>
      <br />
